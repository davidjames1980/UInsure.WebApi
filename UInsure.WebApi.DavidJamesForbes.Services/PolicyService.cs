using AutoMapper;
using UInsure.WebApi.DavidJamesForbes.Data.Repositories;
...
namespace UInsure.WebApi.DavidJamesForbes.Services
{
    public class PolicyService : IPolicyService
    {
        ...
        public async Task<Policy> SellPolicy(PolicyModel policy)
        {
            ...
            if (await _policyRepository.ReferenceExistsAsync(policy.UniqueReference))
        ...
        public async Task<decimal> CalculateCancellationRefund(string uniqueReference, DateTime cancellationDate)
        {
            ...
            var policy = await _policyRepository.GetByReferenceAsync(uniqueReference)
                ?? throw new PolicyNotFoundException();
